...
- **Discovery Cards**: Public photo cards show the image first, then one concise story/title line and relative time metadata. Explore photo thumbnails use square image corners so no photo content is visually clipped.
