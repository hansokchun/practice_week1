      ...
      {failed ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return <RecoverableRemoteImage accessibilityLabel={label} onPress={() => openPhoto(item.id)} onRetry={() => setReloadKey((value) => value + 1)} pressAccessibilityLabel={`${label} 상세 보기`} style={styles.photoTile} uri={item.imageUrl} />;
          }}
        />
      )}
    </SafeAreaView>
