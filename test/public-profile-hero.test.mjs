...
test('getProfileHeroImage prefers the saved profile cover', () => {
    assert.equal(
        getProfileHeroImage('profile-cover.jpg', { cover_url: 'album-cover.jpg' }, []),
        'profile-cover.jpg'
    );
});

test('getProfileHeroImage falls back to selected album cover', () => {
