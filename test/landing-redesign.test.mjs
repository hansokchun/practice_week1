...
test('랜딩은 큰 검색창, 추천 검색어, 가로 사진 섹션을 제공한다', async () => {
    ...
    assert.match(html, /class="landing-search-globe" src="images\/landing-globe-illustration\.svg"/);
...
test('검색창 위에는 지정한 제목만 표시한다', async () => {
    ...
    assert.match(beforeHero, /class="landing-search-globe" src="images\/landing-globe-illustration\.svg"/);
