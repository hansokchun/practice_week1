...
test('DESIGN documents the Explore map shell visual language', () => {
    ...
    assert.match(design, /Each thumbnail uses the panel width in a consistent 4:3 frame/);
    assert.match(design, /Images fit inside the frame without cropping or zooming/);
