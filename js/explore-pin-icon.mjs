...
export const EXPLORE_SELECTED_PIN_COLOR = '#f48c71';
...
export function getExplorePinSymbolIcon(maps, { size = 36, type = 'photo', selected = false } = {}) {
    ...
    const pinSize = selected ? size + 12 : size;
    return {
        path: PHOTO_PIN_PATH,
        fillColor: selected ? EXPLORE_SELECTED_PIN_COLOR : (isCluster ? EXPLORE_CLUSTER_PIN_COLOR : EXPLORE_PHOTO_PIN_COLOR),
        fillOpacity: 1,
        strokeColor: '#ffffff',
        strokeWeight: selected ? 5 : 3,
        scale: (isCluster ? size + 8 : pinSize) / 48,
