# Ikkyee 프로젝트 개요서 (Onboarding Guide)

환영합니다! 이 문서는 새로운 협업자가 **Ikkyee** 프로젝트를 빠르게 파악하고 개발에 참여할 수 있도록 작성된 종합 보고서입니다.
...
작업 방식은 [Superpowers 개발 워크플로우](docs/superpowers.md)를 기준으로 합니다. Superpowers는 앱에 포함되는 기능이 아니라, 계획/테스트/디버깅/검증/배포를 안정적으로 수행하기 위한 개발 운영 원칙입니다.
