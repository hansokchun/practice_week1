...
1. iOS Safari·Android Chrome 실기기에서 새 랜딩과 상세 스크롤을 확인한다.
...
| 웹 랜딩 개편 | 관리자 저장까지 검증 완료 | 큰 검색창, 가로 사진 섹션, 로그인 계정 메뉴, 내 사진 안의 앨범, 거리뷰 성공·미지원 상태를 확인했다. 새 랜딩 테이블·RLS·관리자 실제 저장·익명 조회를 검증했고 실기기 확인 1개 남음 |
